...
namespace GameServerAuthorization
{
    public class AuthOptions
    {
        ...
        public int TokenValidityInMinutes => _configuration.GetValue<int>("AuthOptions:TokenValidityInMinutes");
        public int RefreshTokenValidityOnDays => _configuration.GetValue<int>("AuthOptions:RefreshTokenValidityOnDays");
